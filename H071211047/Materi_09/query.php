...
class MyQuery
{
  ...
  function show_data()
  {
    ...
    $sql = "SELECT customerNumber as id, orderDate as tanggal, customerName as nama FROM orders 
    JOIN customers USING (customerNumber) ORDER BY orderDate DESC LIMIT 5";
    // $sql = "";
